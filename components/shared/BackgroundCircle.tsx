...
const BackgroundCircle = () => {
  return (
    ...
    >
      ...
      <div className=" absolute border border-secondary rounded-full h-[300px] w-[300px] mt-52 animate-ping" />
      <div className=" absolute border border-primary rounded-full h-[500px] w-[500px] mt-52 animate-ping" />
      <div className=" absolute border border-primary rounded-full h-[500px] w-[500px] mt-52 animate-pulse opacity-20" />
